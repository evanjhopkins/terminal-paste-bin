...
Run `tpb` for the default bin or `tpb <name>` for a named bin. The TUI supports selection, full-value viewing, deleting slots, and reading and writing clipboard values.
